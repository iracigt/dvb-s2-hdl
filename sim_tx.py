...
class sim_tx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.iio_pluto_sink_0 = iio.pluto_sink('', int(center_freq), int(samp_rate), 2000000, 32768, False, 60 - tx_gain, '', True)
        ...
        self.connect((self.blocks_add_const_vxx_0, 0), (self.iio_pluto_sink_0, 0))
    ...
    def set_tx_gain(self, tx_gain):
        ...
        self.iio_pluto_sink_0.set_params(int(self.center_freq), int(self.samp_rate), 2000000, 60 - self.tx_gain, '', True)
...
def main(top_block_cls=sim_tx, options=None):
